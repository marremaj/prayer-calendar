...
import { deletePrayer, getAllPrayers, postPrayer } from "../../api";
...
const formatPrayers = (prayers) => {
  ...
  for (const prayer of prayers) {
    ...
    formattedPrayers[date] = {
      ...formattedPrayers[date],
      [prayer.prayer]: { isSelected: "Yes", prayerId: prayer.id },
    };
  }
...
function CalendarView() {
  ...
  return (
    <div className="calendar-view">
      ...
      <CalendarTable startDate={startDate} data={data} addDataFunc={addData} removeDataFunc={removeData} />
      <div>
